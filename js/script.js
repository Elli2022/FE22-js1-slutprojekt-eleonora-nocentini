    ...
    function fetchUsersImage(textPar, numberPar, radioButtonsPar, value) {
        ...
        fetch(url)
            ...
            .then(results => {
                ...
                //Om användaren matar in ett ord som inte finns så ges denna if-sats
                if (results.photos.pages === 0) {
                    h1.innerText = "Du måste skriva in ett giltigt sökord!"
                    imgContainer.innerText = '';
                }
                ...
                photoArr.forEach(element => {
                    ...
                    //Adressen för de renderade bilderna så att de ska kunna visas utifrån inputens som användaren matat in
